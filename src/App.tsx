      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled || isMenuOpen ? 'bg-white/90 backdrop-blur-md border-b border-gray-100 py-4 shadow-sm' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className={`flex items-center gap-3 font-serif font-bold text-xl md:text-2xl tracking-tight transition-colors ${isScrolled || isMenuOpen ? 'text-gray-900' : 'text-white'}`}>
            <img src={logoPng} alt="Logo Hostal Plaza Lebu" className="w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden object-cover shadow-lg border-2 border-white/20" />
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <span className="absolute right-full mr-4 bg-white text-gray-900 px-4 py-2 rounded-xl text-sm font-bold shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-gray-100 pointer-events-none">
